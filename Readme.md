...
Этот файл собирает события в элементе чтобы вы могли использовать
...
Rocet - это основной объект который везет все функции похожие jquery, но главной особеностью является то что может забирать в конструктор.
